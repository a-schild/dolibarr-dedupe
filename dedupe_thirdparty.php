...
llxHeader('', $langs->trans('Deduplicate thirdparties'), '');

echo "<h1>Potential duplicates</h1>";

    $sql = "SELECT a.rowid arowid,a.nom anom, a.email aemail, ";
    $sql .= " a.address aaddress, a.zip azip, a.town atown, ";
    $sql .= " b.rowid browid, b.nom bnom, b.email bemail,  ";
    $sql .= " b.address baddress, b.zip bzip, b.town btown, ";
    $sql .= " concat(soundex(a.nom),soundex(b.nom)) soundval ";
    $sql .= "FROM ".MAIN_DB_PREFIX."societe a join ".MAIN_DB_PREFIX."societe b ";
    $sql .= "where soundex(a.nom) = soundex(b.nom) and a.rowid > b.rowid ";
