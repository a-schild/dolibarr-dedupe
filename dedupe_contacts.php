...
if (! $user->rights->societe->creer) accessforbidden();
...
llxHeader('', $langs->trans('Deduplicate contacts'), '');

echo "<h1>Potential duplicates</h1>";

    $sql = "SELECT a.rowid arowid,a.firstname afirstname, a.lastname alastname, a.email aemail, ";
    $sql .= " a.address aaddress, a.zip azip, a.town atown, ";
    $sql .= " b.rowid browid, b.firstname bfirstname, b.lastname blastname, b.email bemail,  ";
    $sql .= " b.address baddress, b.zip bzip, b.town btown, ";
    $sql .= " concat(soundex(a.firstname),soundex(a.lastname)) soundval ";
    $sql .= "FROM ".MAIN_DB_PREFIX."socpeople a join ".MAIN_DB_PREFIX."socpeople b ";
            ...
            if ($db->num_rows($resql)) 
            {
                ...
                while($obj = $db->fetch_object($resql))
                {
                    ...
                    if (!in_array($obj->arowid, $rowids))
                    {
                        ...
                        echo "<td><a href='../../contact/card.php?id=".$obj->arowid."' target='_blank'>".$obj->arowid."</a></td><td>".
                    ...
                    if (!in_array($obj->browid, $rowids))
                    {
                        ...
                        echo "<td><a href='../../contact/card.php?id=".$obj->browid."' target='_blank'>".$obj->browid."</a></td><td>".
